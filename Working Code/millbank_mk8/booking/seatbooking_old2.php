...
<html>
	...
	var seats = new Array();
		...
		<?php
			...
			$f = 1;
			#Stage Div
			echo '<div id ="stage" style="position:absolute; text-align: center; height:31px; width:538px; background:brown; left:'.$spacer.'">STAGE</div>';
		...
		<input type='text' name='event_id' id= 'event_id' value=<?php echo $id;?> />
	</div>
		...
		<script>
			...
			function postSelectedSeats(){
				...
				if(seats == ''){
					...
					$.post( "bookingseats.php", { seats: seats.toString(), event_id: event_id.toString() }).done(function( data ) {
